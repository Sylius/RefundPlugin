...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('gaufrette.sylius_refund_credit_memo_filesystem', \Gaufrette\Filesystem::class)
        ->args([service('sylius_refund.gaufrette.adapter.credit_memo')]);

    $services->set('sylius_refund.gaufrette.adapter.credit_memo', \Gaufrette\Adapter\Local::class)
