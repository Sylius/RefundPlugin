...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_refund.command_handler.refund_units', \Sylius\RefundPlugin\CommandHandler\RefundUnitsHandler::class)
        ->args([
    ...
    $services->set('sylius_refund.command_handler.generate_credit_memo', \Sylius\RefundPlugin\CommandHandler\GenerateCreditMemoHandler::class)
        ->args([
    ...
    $services->set('sylius_refund.command_handler.send_credit_memo', \Sylius\RefundPlugin\CommandHandler\SendCreditMemoHandler::class)
        ->args([
